...
class MyApp {
  ...
  initCameras() {
    ...
    // Right view orthographic camera
    ...
    orthoRight.position.set(this.frustumSize / 4, 0, 0); // Positioned to the right
    orthoRight.lookAt(new THREE.Vector3(0, 0, 0)); // Looking towards the origin
    this.cameras["Right"] = orthoRight;

    // Back view orthographic camera
    ...
    orthoBack.position.set(0, 0, -this.frustumSize / 4); // Positioned behind
    orthoBack.lookAt(new THREE.Vector3(0, 0, 0)); // Looking towards the origin
